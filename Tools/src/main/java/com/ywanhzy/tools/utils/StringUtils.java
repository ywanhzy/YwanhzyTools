...
public class StringUtils {
     ...
     * @return
     */
    public static String FormartMobile(String _strMobile) {
        if (_strMobile.length() != 11)
            return "";
        return _strMobile.substring(0, 3) + "****" + _strMobile.substring(7, 11);
    }
     ...
     * @return
     */
    public static String FormartEmail(String _strEmail) {
        String[] EmailMain = _strEmail.split("@");
        if (EmailMain[0].length() < 1)
            return "";

        if (EmailMain[0].length() > 4) {
            return EmailMain[0].substring(0, 2) + "****"
                    + EmailMain[0].substring(EmailMain[0].length() - 2, EmailMain[0].length()) + "@" + EmailMain[1];
        } else {
            return EmailMain[0].substring(0, 1) + "****"
                    + EmailMain[0].substring(EmailMain[0].length() - 1, EmailMain[0].length()) + "@" + EmailMain[1];
        }
    }
